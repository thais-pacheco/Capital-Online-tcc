        ...
        <div className="header-container">
          <div className="header-left">
            ...
            <nav className="nav">
              ...
              <button className="nav-button" onClick={() => navigate('/new-transaction')}>
                Nova movimentação
              </button>
              <button className="nav-button">Gráficos</button>
              <button className="nav-button">Objetivos</button>
            </nav>
          </div>
          <div className="header-right">
            ...
            <button className="icon-button logout" onClick={() => navigate('/')}>
              <LogOut size={20} />
            </button>
